...
{
    /// <inheritdoc />
    public partial class loginOtpToken : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChatLoginOtps", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ChatLoginOtps_KCI_Users_UserId",
                        column: x => x.UserId,
